"""
adapted from:
https://github.com/HakamShams/LOAN/blob/main/models/TimeSformer.py
...
class Model(nn.Module):
    """ Vision Transformere
    """
    def __init__(self, configs,img_size=13, patch_size=4, in_chans=38, n_classes=1, embed_dim=96, depths=10,
...
if __name__ == '__main__':
    ...
    device = 'cuda'
    configs = None
    test_d = torch.randn((256, 38, 10, 13, 13)).to(device)
