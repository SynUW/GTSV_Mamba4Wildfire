...
class Model(nn.Module):
    ...
    def forecast(self, x_enc):
        ...
        # keep batch dimension even when B=1; avoid squeeze() collapsing to 2D
        x_enc = x_enc[:, :, :, H // 2, W // 2].permute(0, 2, 1)  # B L N -> B N L
        # normalization
        ...
        y_out = y_out.permute(0, 2, 1)[:, :, 0]  # only predict the first variable
        return y_out
